...
object Pravega {
   ...
   */
  def source[A](scope: String, streamName: String)(implicit
   ...
   */
  def flow[A](scope: String, streamName: String)(implicit
   ...
   */
  def sink[A](scope: String, streamName: String)(implicit
      writerSettings: WriterSettings[A]
  ): Sink[A, Future[Done]] =
