...
object MqttSessionSettings {
   ...
   */
  def apply(maxPacketSize: Int): MqttSessionSettings =
   ...
   */
  def create(maxPacketSize: Int): MqttSessionSettings =
    MqttSessionSettings(maxPacketSize)
}
...
final class MqttSessionSettings private (val maxPacketSize: Int) {
  ...
  private def copy(maxPacketSize: Int = maxPacketSize) = new MqttSessionSettings(maxPacketSize)

  override def toString: String =
    s"MqttSessionSettings(maxPacketSize=$maxPacketSize)"
}
