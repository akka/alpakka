...
public class TestUtils {
    ...
    public static void populateDatabase(InfluxDB influxDB) {
        ...
        Cpu firstCore = new Cpu(Instant.now().minusSeconds(1000), "local_1", "eu-west-2", 1.4d, true, 123l);
        influxDBMapper.save(firstCore);
        Cpu secondCore = new Cpu(Instant.now().minusSeconds(500),"local_2","eu-west-2",1.4d,true,123l);
