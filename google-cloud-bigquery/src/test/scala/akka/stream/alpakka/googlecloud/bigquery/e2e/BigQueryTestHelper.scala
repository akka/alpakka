...
trait BigQueryTestHelper {
  ...
  val forwardProxy = ForwardProxy(proxyHost,proxyPort, Option.empty, Option(ForwardProxyTrustPem("/Users/gkatzioura/Documents/egkatzioura/alpakka/google-cloud-bigquery/src/test/resources/cert.pem")))
