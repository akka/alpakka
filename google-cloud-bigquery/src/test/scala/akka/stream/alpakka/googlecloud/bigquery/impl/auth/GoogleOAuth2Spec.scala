...
import akka.stream.alpakka.googlecloud.bigquery.{BigQuerySettings, HoverflySupport}
...
class GoogleOAuth2Spec
  ...
  implicit val settings = BigQuerySettings(system)
  ...
  val scopes = Seq("https://www.googleapis.com/auth/bigquery")
