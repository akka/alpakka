...
trait BasicSchemas {
  ...
  implicit val floatSchemaWriter: SchemaWriter[Float] = new PrimitiveSchemaWriter(FloatType)
  implicit val doubleSchemaWriter: SchemaWriter[Double] = new PrimitiveSchemaWriter(FloatType)
