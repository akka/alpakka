...
import akka.stream.alpakka.jakartajms.{Destination, JmsBrowseSettings}
 ...
 */
@InternalApi
private[jakartajms] final class JmsBrowseStage(settings: JmsBrowseSettings, queue: Destination)
