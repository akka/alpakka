...
import akka.NotUsed
import akka.stream.alpakka.jakartajms.impl.JmsMessageReader._
...
object JmsMessage {
  ...
  /**
   * Convert a [[jakarta.jms.Message]] to a [[JmsEnvelope]] with pass-through
   */
  ...
  /**
   * Convert a [[jakarta.jms.Message]] to a [[JmsMessage]]
   */
  ...
  /**
   * Java API: Convert a [[jakarta.jms.Message]] to a [[JmsEnvelope]] with pass-through
   */
  def create[PassThrough](message: jms.Message, passThrough: PassThrough): JmsEnvelope[PassThrough] =
    apply(message, passThrough)

  /**
   * Java API: Convert a [[jakarta.jms.Message]] to a [[JmsMessage]]
   */
 ...
 * @tparam PassThrough the type of data passed through the `flexiFlow`
 */
sealed class JmsByteMessagePassThrough[+PassThrough] protected[jakartajms] (
...
object JmsByteMessage {
  ...
  /**
   * Create a byte message from a [[jakarta.jms.BytesMessage]] with pass-through
   */
  ...
  /**
   * Create a byte message from a [[jakarta.jms.BytesMessage]]
   */
  ...
  /**
   * Java API: Create a byte message from a [[jakarta.jms.BytesMessage]] with pass-through
   */
  def create[PassThrough](message: jms.BytesMessage, passThrough: PassThrough): JmsByteMessagePassThrough[PassThrough] =
    apply(message, passThrough)

  /**
   * Java API: Create a byte message from a [[jakarta.jms.BytesMessage]]
   */
 ...
 * @tparam PassThrough the type of data passed through the `flexiFlow`
 */
sealed class JmsByteStringMessagePassThrough[+PassThrough] protected[jakartajms] (
 ...
 * @tparam PassThrough the type of data passed through the `flexiFlow`
 */
sealed class JmsMapMessagePassThrough[+PassThrough] protected[jakartajms] (val body: Map[String, Any],
                                                                           val headers: Set[JmsHeader] = Set.empty,
                                                                           val properties: Map[String, Any] = Map.empty,
                                                                           val destination: Option[Destination] = None,
                                                                           val passThrough: PassThrough)
...
object JmsMapMessage {
  ...
  /**
   * Create a map message from a [[jakarta.jms.MapMessage]] with pass-through
   */
  ...
  /**
   * Create a map message from a [[jakarta.jms.MapMessage]]
   */
  ...
  /**
   * Java API: Create a map message from a [[jakarta.jms.MapMessage]] with pass-through
   */
  def create[PassThrough](message: jms.MapMessage, passThrough: PassThrough): JmsMapMessagePassThrough[PassThrough] =
    apply(message, passThrough)

  /**
   * Java API: Create a map message from a [[jakarta.jms.MapMessage]]
   */
 ...
 * @tparam PassThrough the type of data passed through the `flexiFlow`
 */
sealed class JmsTextMessagePassThrough[+PassThrough] protected[jakartajms] (
    val body: String,
    val headers: Set[JmsHeader] = Set.empty,
    val properties: Map[String, Any] = Map.empty,
    val destination: Option[Destination] = None,
 ...
 * @tparam PassThrough the type of data passed through the `flexiFlow`
 */
sealed class JmsObjectMessagePassThrough[+PassThrough] protected[jakartajms] (
