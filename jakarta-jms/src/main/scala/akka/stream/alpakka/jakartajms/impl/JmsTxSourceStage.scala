...
import akka.stream.alpakka.jakartajms.{AcknowledgeMode, Destination, JmsConsumerSettings, JmsTxAckTimeout, TxEnvelope}
 ...
 */
@InternalApi
private[jakartajms] final class JmsTxSourceStage(settings: JmsConsumerSettings, destination: Destination)
