 ...
 * Internal API.
 */
@InternalApi private final class SetupFlowStage[T, U, M](factory: ActorMaterializer => Attributes => Flow[T, U, M])
 ...
 * Internal API.
 */
@InternalApi private final class SetupSourceStage[T, M](factory: ActorMaterializer => Attributes => Source[T, M])
 ...
 * Internal API.
 */
@InternalApi private[couchbase] object Setup {
