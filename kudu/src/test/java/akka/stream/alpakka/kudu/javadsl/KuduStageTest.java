...
public class KuduStageTest {
    ...
    public void sink() throws ExecutionException, InterruptedException, TimeoutException {
        ...
        //#create-settings
        KuduTableSettings<Person> tableSettings = KuduTableSettings.create(setupKuduClient(), "tablenameSink", schema, createTableOptions, kuduConverter);
        //#create-settings
    ...
    public void flow() throws ExecutionException, InterruptedException {
        ...
        KuduTableSettings<Person> tableSettings = KuduTableSettings.create(setupKuduClient(), "tablenameFlow", schema, createTableOptions, kuduConverter);
