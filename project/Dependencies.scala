...
object Dependencies {
  ...
  val JacksonVersion = "2.18.9" // 2.18 is LTS
  ...
  val CassandraDriverVersionInDocs = "4.19.0"
  ...
  val Jms = Seq(
    libraryDependencies ++= Seq(
        ...
        "com.ibm.mq" % "com.ibm.mq.allclient" % "9.4.5.1" % Test, // IBM International Program License Agreement https://public.dhe.ibm.com/ibmdl/export/pub/software/websphere/messaging/mqdev/maven/licenses/L-APIG-AZYF2E/LI_en.html
