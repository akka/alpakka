...
object Dependencies {
  ...
  val Jms = Seq(
    libraryDependencies ++= Seq(
        ...
        "com.ibm.mq" % "com.ibm.mq.allclient" % "9.4.1.1" % Test, // IBM International Program License Agreement https://public.dhe.ibm.com/ibmdl/export/pub/software/websphere/messaging/mqdev/maven/licenses/L-APIG-AZYF2E/LI_en.html
