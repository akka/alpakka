...
object Dependencies {
  ...
  val GoogleBigQueryStorage = Seq(
    ...
    libraryDependencies ++= Seq(
        ...
        "com.google.api.grpc" % "proto-google-cloud-bigquerystorage-v1" % "3.15.2" % "protobuf-src", // ApacheV2
  ...
  val JakartaJms = Seq(
    libraryDependencies ++= Seq(
        ...
        ("org.apache.activemq" % "artemis-jakarta-server" % "2.55.0" % Test),
        ("org.apache.activemq" % "artemis-jakarta-client" % "2.55.0" % Test)
      ) ++ Mockito
  )
