...
package akka.stream.alpakka.stdin.scaladsl

import akka.NotUsed
import akka.stream.scaladsl.Source
import akka.stream.alpakka.stdin.{impl, StdinSourceReader, StdinSourceReaderIo}
...
object StdinSource {
   ...
   *               need to change this from the default [[akka.stream.alpakka.stdin.StdinSourceReaderIo]] value
