...
final class StorageObject private (
    ...
    val contentTypeOptional: Option[ContentType],
    val size: Long,
    val etag: String,
    val md5Hash: String,
    val md5HashOptional: Option[String],
    val crc32c: String,
    val crc32cOptional: Option[String],
    ...
    val storageClassOptional: Option[String],
  ...
  private def copy(
    ...
    contentTypeOptional = Option(contentType),
    size = size,
    etag = etag,
    md5Hash = md5Hash,
    md5HashOptional = Option(md5Hash),
    crc32c = crc32c,
    crc32cOptional = Option(crc32c),
    mediaLink = mediaLink,
    selfLink = selfLink,
    updated = updated,
    ...
    storageClassOptional = Option(storageClass),
