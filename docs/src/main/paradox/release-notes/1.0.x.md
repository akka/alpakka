...
With this 1.0.0 release Alpakka is another member of the [Akka family](https://doc.akka.io/) promising great Open Source software with the [Reactive Manifesto](https://www.reactivemanifesto.org/) in mind.
...
* Official support is now available via [Lightbend Platform Subscription](https://akka.io/pricing) for the first modules: Couchbase and CSV ([Alpakka Kafka](https://doc.akka.io/libraries/alpakka-kafka/current/) has been supported for a while)
