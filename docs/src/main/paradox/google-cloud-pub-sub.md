...
:   @@@vars
    ...
    <dependency>
      ...
      <artifactId>akka-stream-alpakka-google-cloud-pub-sub_$scala.binaryVersion$</artifactId>
...
:   @@@vars
    ```gradle
    dependencies {
      compile group: "com.lightbend.akka", name: "akka-stream-alpakka-google-cloud-pub-sub_$scala.binaryVersion$", version: "$version$"
    }
    ```
    @@@
